...
class LinearTransformationScene(VectorScene):
    ...
    def get_matrix_transformation(self, matrix):
        ...
        naive_transformation represented by the matrix passed.
    ...
    def get_transposed_matrix_transformation(self, transposed_matrix):
        """
        Returns a function corresponding to the linear
        naive_transformation represented by the transposed
        matrix passed.
    ...
    def apply_matrix(self, matrix, **kwargs):
        """
        Applies the naive_transformation represented by the
    ...
    def apply_inverse(self, matrix, **kwargs):
        """
        This method applies the linear naive_transformation
    ...
    def apply_inverse_transpose(self, t_matrix, **kwargs):
        """
        Applies the inverse of the naive_transformation represented
    ...
    def apply_nonlinear_transformation(self, function, **kwargs):
        """
        Applies the non-linear naive_transformation represented
